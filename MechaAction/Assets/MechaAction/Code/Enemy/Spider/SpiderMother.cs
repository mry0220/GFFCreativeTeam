...
public class SpiderMother : MonoBehaviour
{
    ...
    const float _ditection = 13;       //���G�͈͂��m�肵����const�ɕύX
    const float _turnTime = 2f;      //�d�����Ԃ��m�肵����const�ɕύX
    ...
    private void _Gravity()
    {
        ...
        _velocity.y += _fallSpeed * Time.fixedDeltaTime; // Y���x�ɏ��X�ɉ��Z
                                                         //Time.fixedDeltaTime �������Z���t���[�����[�g�Ɉˑ������Ȃ����ߕK�{
        if (_velocity.y < -20f)//�������x�̐���
        {
            _velocity.y = -20f;
        }
    }
